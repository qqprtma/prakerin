<div>
    <div class="form-group row ">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="@if (isset($tracking1)){{$tracking1->positif}} @endif" name="positif" required>
        </div>
    </div>
    ...
    <div class="form-group row ">
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control" value="@if (isset($tracking1)){{$tracking1->tanggal}} @endif "name="tanggal" required>
        </div>
    </div>
    <div class="form-group row ">
        <div class="col-md-6">
